...
import CodeChefCard from "../components/profile/CodeChefCard";
...
const ProfileDashboard = () => {
  ...
  return (
  <GradientBackground className="min-h-screen text-white flex flex-col px-2 sm:px-4 md:px-6 pt-8 sm:pt-12 pb-8 sm:pb-12">
